...
const win32 = struct {
    ...
    usingnamespace @import("win32").windows.win32.system.system_services;
    usingnamespace @import("win32").windows.win32.ui.windows_and_messaging;
    usingnamespace @import("win32").windows.win32.graphics.gdi;
    usingnamespace @import("win32").windows.win32.graphics.direct2d;
    usingnamespace @import("win32").windows.win32.graphics.direct2d.common;
    usingnamespace @import("win32").windows.win32.graphics.direct3d9;
    usingnamespace @import("win32").windows.win32.graphics.dxgi.common;
...
fn MainWindowHandleMessage(self: *MainWindow, uMsg: u32, wParam: WPARAM, lParam: LPARAM) LRESULT {
    switch (uMsg) {
        win32.WM_CREATE => {
            ...
            if (FAILED(win32.D2D1CreateFactory(win32.D2D1_FACTORY_TYPE_SINGLE_THREADED, win32.IID_ID2D1Factory, null, @ptrCast(&self.pFactory)))) {
